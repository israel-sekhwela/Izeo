...
<head>
    ...
    <script src="js/bio-validation.js"></script>
    <style>
        body
        {
             ...
             <br /><p id="bioval"></p>
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="well">
                            <div class="settings">
                                <h2 id="white" style="text-decoration:underline;"><?php echo $srow["firstname"]; ?>'s Bio</h2>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <form action="scripts/update-student-bio.php" name="editform" onsubmit="return CheckUpdateStudent()" method="POST">
                                        ...
                                        <textarea class="form-control" rows="9" name="bio" placeholder="Update bio"></textarea>
                                        <p id="bval"></p>
                                        </div>
                                        <br />
