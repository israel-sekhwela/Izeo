            ...
            <div id="requests-section">
                ...
                <div id="search-bar">
                    <form action="" method="GET">
                        <input type="text" style="float:left;" name="query" placeholder="Search student posts.." />
                    </form>
                    <br /><br />
                </div>
                <div id="search-area">
                    ...
                    <?php
                        ...
                        {
                            $raw_results = mysqli_query($dbcon, "SELECT * FROM posts WHERE (`student` LIKE '%".$query."%') OR (`postto` LIKE '%".$query."%') OR (`post` LIKE '%".$query."%')");

                            if(mysqli_num_rows($raw_results) > 0)
                            {
                                $numofposts = mysqli_num_rows($raw_results);
                                
                                echo "<h3>$numofposts posts were found from your search</h3><br /><br />";

                                while($results = mysqli_fetch_array($raw_results))
                                {
                                    echo "<div class='col-sm-12'>" .
                                "<div " .
                                "<h1>" . $results["student"] . " &#8594; " . $results["postto"] . "</h1>" .
                                "<h4>" . $results["post"] . "</h4>" .                     
                                "</div>" .
                                "<p>" . $results["dateposted"] . "</p>" .
                                "</div>";
                                }
                        ...
                        {
                            echo "<h3>Please enter more than " . $min_length . " characters for improved posts search</h3>";
                        }
                    ?>
                </div>
